...
class S3Storage(S3Boto3Storage):
    ...
    def __init__(self, request=None):
        ...
        if os.environ.get("USE_MINIO") == "1":
            ...
            # For local development without proxy, use direct MinIO endpoint
            # Set MINIO_USE_PROXY=0 in .env for local development
            use_proxy = os.environ.get("MINIO_USE_PROXY", "1") == "1"
