...
export const TYPOGRAPHY_ITEMS: ToolbarMenuItem<"text" | "h1" | "h2" | "h3" | "h4" | "h5" | "h6">[] = [
  { itemKey: "text", renderKey: "text", name: "editor.toolbar.text", icon: CaseSensitive, editors: ["document"] },
  { itemKey: "h1", renderKey: "h1", name: "editor.toolbar.h1", icon: Heading1, editors: ["document"] },
  { itemKey: "h2", renderKey: "h2", name: "editor.toolbar.h2", icon: Heading2, editors: ["document"] },
  { itemKey: "h3", renderKey: "h3", name: "editor.toolbar.h3", icon: Heading3, editors: ["document"] },
  { itemKey: "h4", renderKey: "h4", name: "editor.toolbar.h4", icon: Heading4, editors: ["document"] },
  { itemKey: "h5", renderKey: "h5", name: "editor.toolbar.h5", icon: Heading5, editors: ["document"] },
  { itemKey: "h6", renderKey: "h6", name: "editor.toolbar.h6", icon: Heading6, editors: ["document"] },
];
...
export const TEXT_ALIGNMENT_ITEMS: ToolbarMenuItem<"text-align">[] = [
  {
    ...
    name: "editor.toolbar.left_align",
    icon: AlignLeft,
  ...
  },
  {
    ...
    name: "editor.toolbar.center_align",
    icon: AlignCenter,
  ...
  },
  {
    ...
    name: "editor.toolbar.right_align",
    icon: AlignRight,
...
const LIST_ITEMS: ToolbarMenuItem<"bulleted-list" | "numbered-list" | "to-do-list">[] = [
  {
    ...
    name: "editor.toolbar.numbered_list",
    icon: ListOrdered,
  ...
  },
  {
    ...
    name: "editor.toolbar.bulleted_list",
    icon: List,
  ...
  },
  {
    ...
    name: "editor.toolbar.to_do_list",
    icon: ListTodo,
...
const USER_ACTION_ITEMS: ToolbarMenuItem<"quote" | "code">[] = [
  { itemKey: "quote", renderKey: "quote", name: "editor.toolbar.quote", icon: TextQuote, editors: ["lite", "document"] },
  { itemKey: "code", renderKey: "code", name: "editor.toolbar.code", icon: Code2, editors: ["lite", "document"] },
];
...
const COMPLEX_ITEMS: ToolbarMenuItem<"table" | "image">[] = [
  { itemKey: "table", renderKey: "table", name: "editor.toolbar.table", icon: Table, editors: ["document"] },
  IMAGE_ITEM,
];
