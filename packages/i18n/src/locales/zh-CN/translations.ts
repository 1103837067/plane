export default {
  ...
  auth: {
    tagline: "在所有维度中工作。",
    welcome_back: "欢迎回到 Plane。",
    create_account_tagline: "创建您的 Plane 账号。",
    terms_and_conditions: {
      by_signing_in: "登录即表示您理解并同意",
      by_creating_account: "创建账号即表示您理解并同意",
      our: "我们的",
    ...
    oauth: {
      ...
      sign_up_with: "使用 {provider} 注册",
    },
    workspace_restriction: "您似乎没有收到工作空间的邀请，并且您的实例管理员已限制创建新的工作空间。请先请求工作空间所有者或管理员邀请您加入工作空间，然后返回此屏幕加入。",
    onboarding: {
      continue: "继续",
      skip: "跳过",
      role: {
        title: "您的角色是什么?",
        description: "让我们根据您的工作方式设置 Plane。",
        select_one: "选择一个",
      ...
      use_case: {
        title: "是什么让您来到 Plane?",
        description: "告诉我们您的目标和团队规模。",
        select_one_or_more: "选择一个或多个",
        required: "请至少选择一个选项",
        plan_and_track_product_roadmaps: "规划和跟踪产品路线图",
        manage_engineering_sprints: "管理工程冲刺",
        coordinate_cross_functional_projects: "协调跨职能项目",
        replace_current_tool: "替换我们当前的工具",
        just_exploring: "只是探索",
      },
      profile: {
        title: "创建您的个人资料。",
        description: "这是您在 Plane 中的显示方式。",
      },
      team: {
        title: "邀请您的团队成员",
        description: "在 Plane 中与团队一起工作效果最佳。现在邀请他们,充分发挥 Plane 的潜力。",
        email: "邮箱",
        role: "角色",
      },
    },
  ...
  notifications: "通知",
  workspaces: "工作区",
  language_and_time: "语言和时区",
  timezone_setting: "当前时区设置。",
  language_setting: "选择用户界面中使用的语言。",
  your_profile: "您的个人资料",
  ...
  settings_description: "在一个地方管理您的账号、工作区和项目偏好设置。在标签页之间切换以轻松配置。",
  ...
  workspace_settings: {
    ...
    settings: {
      ...
      exports: {
        heading: "导出",
        description: "以各种格式导出您的项目数据，并通过下载链接访问您的导出历史。",
        title: "导出",
        exporting: "导出中",
      ...
      webhooks: {
        heading: "Webhooks",
        description: "当项目事件发生时自动向外部服务发送通知。",
        title: "Webhooks",
  ...
  profile: {
    ...
    activity_messages: {
      set_priority_to: "设置优先级为",
      none: "无",
      set_state_to: "设置状态为",
      added_new_assignee: "添加了新的受理人",
      removed_assignee: "移除了受理人",
      set_parent_to: "设置父级为",
      removed_parent: "移除了父级",
      created: "创建了",
      deleted: "删除了",
      converted_to_epic: "转换为史诗",
      converted_to_work_item: "转换为工作项",
      added_new_label: "添加了新的标签",
      removed_label: "移除了标签",
      added_this: "添加了此",
      updated_the: "更新了",
      removed_this: "移除了此",
      ...
      this_work_item: "此工作项",
      to_the_cycle: "到周期",
      set_the_cycle_to: "设置周期为",
      removed: "移除了",
      from_the_cycle: "从周期",
      to_the_module: "到模块",
      set_the_module_to: "设置模块为",
      from_the_module: "从模块",
      set_the_title_to: "设置标题为",
      removed_the_start_date: "移除了开始日期",
      set_the_start_date_to: "设置开始日期为",
      removed_the_due_date: "移除了截止日期",
      set_the_due_date_to: "设置截止日期为",
      uploaded_a_new_attachment: "上传了新的附件",
      removed_an_attachment: "移除了附件",
      updated_the_description: "更新了描述",
      removed_the_estimate_point: "移除了估算点",
      set_the_estimate_point_to: "设置估算点为",
      marked_that: "标记为",
      relates_to: "关联到",
      removed_the_relation_from: "移除了关联",
      is_blocking_work_item: "阻塞工作项",
      removed_the_blocking_work_item: "移除了阻塞工作项",
      is_being_blocked_by: "被阻塞",
      removed_being_blocked_by_work_item: "移除了被阻塞的工作项",
      as_duplicate_of: "重复项",
      removed_as_a_duplicate_of: "移除了重复项",
      declined_work_item: "拒绝了工作项",
      declined_this_work_item_from_intake: "从收集箱拒绝了此工作项",
      snoozed_work_item: "暂停了工作项",
      snoozed_this_work_item: "暂停了此工作项",
      accepted_work_item: "接受了工作项",
      accepted_this_work_item_from_intake: "从收集箱接受了此工作项",
      from_intake_by_marking_a_duplicate_work_item: "通过标记重复工作项从收集箱",
      updated_intake_work_item_status: "更新了收集工作项状态",
      restored: "恢复了",
      archived: "归档了",
      a_work_item: "一个工作项",
      prepositions: {
  ...
  project_settings: {
    ...
    members: {
      ...
      project_lead: {
        label: "项目负责人",
        title: "项目负责人",
        description: "选择项目的负责人。",
      },
      default_assignee: {
        label: "默认受理人",
        title: "默认受理人",
        description: "选择项目的默认受理人。",
      },
      guest_access: {
        title: "访客权限",
        description: "这将允许访客查看所有项目工作项。",
      },
    ...
    labels: {
      heading: "标签",
      description: "创建自定义标签以分类和组织您的工作项",
      label_title: "标签标题",
    ...
    automations: {
      heading: "自动化",
      description: "配置自动化操作以简化您的项目管理工作流程并减少手动任务。",
      label: "自动化",
      "auto-archive": {
        title: "自动归档已关闭的工作项",
  ...
  issue_activity: {
    ...
    created_work_item_via: "通过以下方式创建了工作项",
    deleted_work_item: "删除了工作项",
    set_state_to: "将状态设置为",
    for: "对于",
    added_to_module: "将工作项添加到模块",
    set_module_to: "将模块设置为",
    removed_from_module: "从模块中移除了工作项",
    added_to_cycle: "将工作项添加到周期",
    set_cycle_to: "将周期设置为",
    removed_from_cycle: "从周期中移除了工作项",
  },
  themes: {
    theme_options: {
      system_preference: {
  ...
  power_k: {
    contextual_actions: {
      work_item: {
        ...
        copy_id_toast_error: "复制工作项 ID 时出错。",
        copy_title: "复制标题",
        copy_title_toast_success: "工作项标题已复制到剪贴板。",
        copy_title_toast_error: "复制工作项标题时出错。",
        copy_url: "复制 URL",
        copy_url_toast_success: "工作项 URL 已复制到剪贴板。",
        copy_url_toast_error: "复制工作项 URL 时出错。",
      },
      cycle: {
        title: "周期操作",
        indicator: "周期",
        ...
        copy_url_toast_error: "复制周期 URL 时出错。",
      },
      module: {
        title: "模块操作",
        indicator: "模块",
        ...
        copy_url_toast_error: "复制模块 URL 时出错。",
      },
      page: {
        title: "页面操作",
        indicator: "页面",
        ...
        copy_url_toast_error: "复制页面 URL 时出错。",
      },
    },
    creation_actions: {
    ...
    navigation_actions: {
      ...
      nav_subscribed_workspace_work_items: "前往已订阅的工作项",
    ...
    miscellaneous_actions: {
      ...
      copy_current_page_url_toast_error: "复制当前页面 URL 时出错。",
      focus_top_nav_search: "聚焦搜索输入框",
    },
    preferences_actions: {
      update_theme: "更改界面主题",
  ...
  horizontal_navigation_bar: "选项卡导航",
  show_limited_projects_on_sidebar: "在侧边栏显示有限的项目",
