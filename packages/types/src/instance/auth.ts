...
export type TInstanceFeishuAuthenticationConfigurationKeys =
  | "FEISHU_APP_ID"
  | "FEISHU_APP_SECRET"
  | "ENABLE_FEISHU_SYNC";
...
export type TInstanceAuthenticationConfigurationKeys =
  ...
  | TInstanceFeishuAuthenticationConfigurationKeys;
...
export type TCoreLoginMediums = "email" | "magic-code" | "github" | "gitlab" | "google" | "gitea" | "feishu";
